A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Members of Queue With Skill
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-members-of-queue-with-skill-data-action-module.git?ref=main"
    action_name        = "Get Members of Queue With Skill"
